...
const TRACKED_UBER_STATES: TrackedUberState[] = [
  ...
  { uberId: { group: 6, state: 500 }, trackingId: 'relic_count_total' },
  { uberId: { group: 6, state: 501 }, trackingId: 'relic_count' },
  { uberId: { group: 6, state: 502 }, trackingId: 'tree_count' },
  { uberId: { group: 6, state: 503 }, trackingId: 'wisp_count' },
  { uberId: { group: 6, state: 504 }, trackingId: 'quest_count' },
  { uberId: { group: 6, state: 505 }, trackingId: 'relic_current_area_uncollected' },
