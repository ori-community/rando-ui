...
const TRACKED_UBER_STATES: TrackedUberState[] = [
  ...
  { uberId: { group: 28, state: 1 }, trackingId: "door_lupo_shop_door_outside"},
  { uberId: { group: 28, state: 2 }, trackingId: "door_lupo_shop_door_inside"},
  { uberId: { group: 28, state: 3 }, trackingId: "door_hut_bentrance"},
  { uberId: { group: 28, state: 4 }, trackingId: "door_hut_bexit"},
  { uberId: { group: 28, state: 5 }, trackingId: "door_hut_centrance"},
  { uberId: { group: 28, state: 6 }, trackingId: "door_hut_cexit"},
  { uberId: { group: 28, state: 7 }, trackingId: "door_hut_dentrance"},
  { uberId: { group: 28, state: 8 }, trackingId: "door_hut_dexit"},
  { uberId: { group: 28, state: 9 }, trackingId: "door_hut_eentrance"},
  { uberId: { group: 28, state: 10 }, trackingId: "door_hut_eexit"},
  { uberId: { group: 28, state: 11 }, trackingId: "door_hut_fentrance"},
  { uberId: { group: 28, state: 12 }, trackingId: "door_hut_fexit"},
  { uberId: { group: 28, state: 13 }, trackingId: "door_cave_entrance"},
  { uberId: { group: 28, state: 14 }, trackingId: "door_cave_exit"},
  { uberId: { group: 28, state: 15 }, trackingId: "door_water_mill_outside_door_a"},
  { uberId: { group: 28, state: 16 }, trackingId: "door_water_mill_inside_door_a"},
  { uberId: { group: 28, state: 17 }, trackingId: "door_water_mill_outside_door_b"},
  { uberId: { group: 28, state: 18 }, trackingId: "door_water_mill_inside_door_b"},
  { uberId: { group: 28, state: 19 }, trackingId: "door_water_mill_outside_door_c"},
  { uberId: { group: 28, state: 20 }, trackingId: "door_water_mill_inside_door_c"},
  { uberId: { group: 28, state: 21 }, trackingId: "door_water_mill_outside_door_d"},
  { uberId: { group: 28, state: 22 }, trackingId: "door_water_mill_inside_door_d"},
  { uberId: { group: 28, state: 23 }, trackingId: "door_baurs_reach_hut_entrance"},
  { uberId: { group: 28, state: 24 }, trackingId: "door_baurs_reach_hut_exit"},
  { uberId: { group: 28, state: 25 }, trackingId: "door_petrified_hut_door_outside"},
  { uberId: { group: 28, state: 26 }, trackingId: "door_petrified_hut_door_inside"},
  { uberId: { group: 28, state: 27 }, trackingId: "door_desert_ruins_entrance_door"},
  { uberId: { group: 28, state: 28 }, trackingId: "door_door_b"}, // Outer ruins door
  { uberId: { group: 28, state: 29 }, trackingId: "door_willows_end_entrance"},
  { uberId: { group: 28, state: 30 }, trackingId: "door_willows_end_exit"},
  { uberId: { group: 28, state: 31 }, trackingId: "door_powl_arena_entrance"},
  { uberId: { group: 28, state: 32 }, trackingId: "door_powl_arena_exit"},
]
