  ...
  <div class="resource-timer-view">
    <div class="resource-timer-grid" :style="{ '--scaling-factor': resourcesScalingFactor }">
      ...
      <div class="line">
        ...
        <span class="value">
          <span :class="{ completed: gladesRebuildProjectsDone }">{{ gorlekOre }}</span><span class="small"
            :class="{ completed: gorlekOreCollected >= 29 || gladesRebuildProjectsDone }">/{{ gorlekOreCollected }}</span>
        </span>
      </div>
      ...
      <div v-if="showRelics" class="line">
        <div class="image">
          <img v-if="currentAreaHasUncollectedRelic" src="@/assets/images/tracker/map_stone_highlight.png" />
          <img v-else src="@/assets/images/tracker/map_stone.png" />
        </div>
        <div class="value"
